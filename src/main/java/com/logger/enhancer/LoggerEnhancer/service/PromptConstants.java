...
public class PromptConstants {
    public static final String PROMPT_CONSTANT1="Analyze and enhance logger usage for each Java class and method: " +
    ...
    public static final String PROMPT_CONSTANT2="Analyze each existing logger having length greater than 0 present in each java class against regular expression ^[a-zA-Z0-9_.:]{1,100}$" +
            "and only a list of structured JSON object without any plain text with " +
            "json Copy Edit { \\\"className\\\": \\\"com.example.MyClass\\\", \\\"methodName\\\": \\\"myMethod\\\", \\\"lineNumber\\\": 42, \\\"oldLogger\\\": \\\"logger.info(\\\\\\\"Starting process\\\\\\\")\\\", \\\"suggestedLogger\\\": \\\"Logger line should have only min 20 and max 100 characters, should be alpahnumeric and can contain only _ or : or . special char\\\" } " +
            "If no logger exists in a method but one is recommended, oldLogger should be null. " +
            "Please be concise but complete. Only output this structured comparison for valid .java source files and methods. Do not hallucinate classes/methods.\""+
            "\n"+" Below is our java code"
            +"\n";

    public static final String PROMPT_CONSTANT3="Analyze each existing logger having length greater than 0 present in each java class containing sensitive and confidential information" +
            "and only a list of structured JSON object without any plain text with " +
            "json Copy Edit { \\\"className\\\": \\\"com.example.MyClass\\\", \\\"methodName\\\": \\\"myMethod\\\", \\\"lineNumber\\\": 42, \\\"oldLogger\\\": \\\"logger.info(\\\\\\\"Starting process\\\\\\\")\\\", \\\"suggestedLogger\\\": \\\"Logger line should not have any sensitive/confidential information present\\\" } " +
            "If no logger exists in a method but one is recommended, oldLogger should be null. " +
            "Please be concise but complete. Only output this structured comparison for valid .java source files and methods. Do not hallucinate classes/methods.\""+
            "\n"+" Below is our java code"
            +"\n";
